...
def clip():
	...
	zoom = 1/math.tan(90/2)
	f = 1000
	n = .0001
	clipMatrix = numpy.array([zoom, 0, 0, 0], [0, zoom, 0, 0], [0, 0, (f+n)/(f-n), -2(n*f)/(f-n)], [0, 0, 1, 0])
...
def toScreenSpace():
	list = []
	transformationMatrix = numpy.array([256, 0, 256], [0, -256, 256], [0, 0, 1])
	#numpy.matmul(transformationMatrix, )
